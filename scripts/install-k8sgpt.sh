...
$K8SGPT_CONFIG_DIR/switch-model.sh llama2:13b
...
- Config Directory: \`$K8SGPT_CONFIG_DIR\`
- Model Switcher: \`$K8SGPT_CONFIG_DIR/switch-model.sh\`
...
\`\`\`bash
# Use faster model
$K8SGPT_CONFIG_DIR/switch-model.sh orca-mini:latest
